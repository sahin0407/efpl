...
export function LiveMatchControl({
    ...
    return (
      ...
      >
        ...
        <div className="mt-8 flex flex-col gap-3">
          {!shootoutMode && (
            <>
              <button onClick={handleUpdate} className="w-full border border-cyber-purple text-cyber-purple font-sans font-bold uppercase tracking-[0.2em] text-[10px] rounded-sm py-3 transition-colors hover:bg-cyber-purple hover:text-white">
                Update Score
              </button>
          ...
          <button onClick={handleCancelLive} className="w-full border border-brand-border text-brand-gray font-sans font-bold uppercase tracking-[0.2em] text-[10px] rounded-sm py-3 transition-colors hover:text-brand-text">
            Cancel Live
          </button>
        </div>
      </motion.div>
  ...
  return (
    ...
    >
      <h3 className="font-playfair italic text-2xl text-brand-text tracking-tight mb-6">Live Match</h3>
      ...
      {upcomingMatches.length === 0 ? (
        ...
        <div className="space-y-6">
          <select 
            ...
            className="w-full bg-transparent border-b border-brand-border pb-3 text-brand-text focus:outline-none focus:border-cyber-purple focus:bg-brand-input-focus appearance-none font-sans text-sm rounded-none"
          >
          ...
          <button 
            ...
            className={`w-full font-sans font-bold uppercase tracking-[0.2em] text-[10px] rounded-sm py-4 transition-colors flex justify-center items-center gap-2 ${
              selectedMatchId ? 'bg-cyber-purple text-white hover:bg-opacity-90 animate-pulse' : 'bg-brand-surface border border-brand-muted text-[#A0A0A0] cursor-not-allowed'
            }`}
          >
            GO LIVE
          </button>
