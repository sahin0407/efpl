      ...
      >
        ...
        <div className="flex justify-center items-center gap-4 sm:gap-8 mb-6">
           <div className="flex flex-col items-center flex-1">
             ...
             <span className="font-sans font-bold text-brand-dark mt-3 text-center text-sm md:text-base leading-tight">{teamA.name}</span>
           </div>
           
           <div className="flex items-center gap-4">
             <span className="font-mono text-5xl font-black text-brand-dark leading-none">{match.scoreA ?? 0}</span>
             <span className="font-sans text-brand-gray text-xl">-</span>
             <span className="font-mono text-5xl font-black text-brand-dark leading-none">{match.scoreB ?? 0}</span>
           </div>
           
           <div className="flex flex-col items-center flex-1">
             <ClubBadge clubId={teamB.id} size={48} />
             <span className="font-sans font-bold text-brand-dark mt-3 text-center text-sm md:text-base leading-tight">{teamB.name}</span>
           </div>
        </div>
