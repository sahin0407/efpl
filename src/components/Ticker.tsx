...
export function Ticker({ matches, standings }: { matches?: Match[], standings?: ClubStats[] }) {
  ...
  return (
    <div className="w-full bg-accent-gradient border-b border-brand-border overflow-hidden whitespace-nowrap py-1.5 flex items-center">
      <div className="ticker-wrap flex">
        <div className="ticker-track flex">
          <span className="text-white font-sans text-[10px] font-bold tracking-[0.2em] uppercase pr-8 whitespace-nowrap">
            {finalText}
          </span>
          <span className="text-white font-sans text-[10px] font-bold tracking-[0.2em] uppercase pr-8 whitespace-nowrap">
            {finalText}
