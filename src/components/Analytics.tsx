  ...
  return (
    ...
    >
      <div className="text-center mb-10 pt-4">
        <span className="text-[10px] text-cyber-pink font-sans font-bold tracking-[0.25em] uppercase mb-2 block">
          ANALYTICS
        </span>
        <h2 className="font-playfair text-4xl md:text-5xl italic text-brand-text tracking-tight">
          Progress
        </h2>
      </div>
