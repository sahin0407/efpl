    ...
    <div className="w-full pt-8 pb-10 border-t border-brand-border mt-8">
      ...
      <form onSubmit={handleSubmit} className="bg-brand-surface p-6 border border-brand-border rounded-sm box-shadow-editorial">
        <textarea
          ...
          className="w-full bg-transparent border-b border-brand-border pb-3 text-brand-dark focus:outline-none focus:border-brand-accent focus:bg-brand-input-focus font-sans text-sm resize-none"
          rows={3}
          placeholder="Leave blank for auto dynamic text, or enter custom text..."
        />
        <button
          type="submit"
          className="w-full bg-brand-dark text-white font-sans font-bold uppercase tracking-[0.2em] text-[10px] rounded-sm py-4 mt-6 transition-opacity hover:opacity-80 flex items-center justify-center gap-2"
        >
